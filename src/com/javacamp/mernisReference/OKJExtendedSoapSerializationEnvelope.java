...
public class OKJExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(OKJDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new OKJStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static OKJDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static OKJDateTimeConverter dateTimeConverter = new OKJStandardDateTimeConverter();

    public OKJExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public OKJExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OKJMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=OKJHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,OKJExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=OKJHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
