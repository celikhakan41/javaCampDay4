...
public class OKJKPSPublicSoap
{
    ...
    public OKJKPSPublicSoap(){}

    public OKJKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public OKJKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        OKJExtendedSoapSerializationEnvelope envelope= new OKJExtendedSoapSerializationEnvelope(OKJExtendedSoapSerializationEnvelope.VER11);
